...
export class GetPodcastLoookupUseCase {
    execute = async (id: number, podcastLookupRepository: PodcastRepository, localStoreRepository: StorePodcastLookupRepository, clock: Clock) => {
